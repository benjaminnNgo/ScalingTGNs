        ...
        for epoch in range(self.start_epoch + 1, args.max_epoch + 1):
            ...
            for dataset_idx in dataset_rnd:
                ...
                for t_train_idx, t_train in enumerate(self.train_shots[dataset_idx]):
                    ...
                    embeddings = self.model(edge_index, x=None)
                    exit()
                    # graph readout
...
if __name__ == '__main__':
    ...
    category = "HTGN" #"nout" #"rand_data" "HTGN"
    # data_number = 3
    for nout in [32]:
    ...
    # print(a)
    # print(a.shape)
    # edgelist_df = pd.read_csv("/network/scratch/r/razieh.shirzadkhani/fm/fm_data/data_lt_70/all_data/raw/edgelists/IOTX0x6fb3e0a217407efff7ca062d46c26e5d60a14d69_edgelist.txt")
